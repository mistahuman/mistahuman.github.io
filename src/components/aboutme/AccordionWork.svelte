	...
	<Accordion.Item value="freelancer">
		...
		<div class="p-3 space-y-3">
			<header class="space-y-1">
				<h3 class="text-base font-semibold text-primary">Full Stack Developer & Software Engineer</h3>
      ...
      <p>
        I design and build custom software solutions for web and automation.  
        My focus is on clean architecture, efficient code, and seamless user experience.
      </p>
      <p>
        Working mainly with <strong>Astro</strong>, <strong>Svelte</strong>, and <strong>TailwindCSS</strong> on the frontend,  
        and <strong>Python</strong> / <strong>Flask</strong> on the backend.
      </p>
    </div>
		</div>
		{/snippet}
	...
	<Accordion.Item value="nier">
		...
		<div class="p-3 space-y-3">
			...
			<div class="text-sm space-y-3 leading-relaxed">
				<p>
					Design and implementation of the full software development lifecycle for <strong>safety-critical systems</strong>, including:
				</p>

				<ul class="list-disc pl-5 space-y-1">
					<li><strong>Development of safety-critical software</strong> for ERTMS systems (Interlocking, RBC).</li>
				...
				<ul class="list-disc pl-5 space-y-3">
					<li>
						<strong>
							<a href="https://www.niering.it/software-gestionali-hr-le-nuove-funzionalita-di-matriskills/" class="anchor">
								MatriSkillS
							</a>
						</strong>
						<p><strong>Role:</strong> Full Stack Developer</p>
						<p>
							Software platform for personnel management and professional growth, including candidate selection and skill search.
						</p>
					...
					<li>
						<strong>
							<a href="https://www.niering.it/case_histories/simulatore-multiprotocollo-emuxp/" class="anchor">
								EmuXP
							</a>
						</strong>
						<p><strong>Role:</strong> Full Stack Developer</p>
